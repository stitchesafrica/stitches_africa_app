...
class TailorSideFeaturedWorksWidget extends StatelessWidget {
  final String imageUrl;
  TailorSideFeaturedWorksWidget({super.key, required this.imageUrl});
            ...
            children: [
              SlidableAction(
                onPressed: (context) async {
                  await firebaseFirestoreFunctions.removeImageFromFeaturedWorks(
                      getCurrentUserId(), imageUrl);
