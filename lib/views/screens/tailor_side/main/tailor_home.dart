...
import 'package:stitches_africa/views/widgets/tailor_side/tailor_onboarding/tailor_home/tailor_home_onboarded_widget.dart';
      ...
      body: FutureBuilder<bool>(
          ...
          builder: (context, snapshot) {
            ...
            if (isTailorOnBoarded) {
              return const TailorHomeOnboardedWidget();
            } else {
